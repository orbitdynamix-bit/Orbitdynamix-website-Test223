...
class InfiniteGridMenu {
    ...
    #initTexture() {
        ...
        // Fill with a 1x1 white pixel as a placeholder
        ...
        Promise.all(
                ...
                item =>
                    new Promise<HTMLImageElement>(resolve => {
                        ...
                        img.onerror = () => {
                            ...
                            if (item.title) pctx.fillText(item.title, cellSize / 2, cellSize / 2);
            ...
            console.error("Failed to load images for InfiniteMenu atlas:", err);
        });
    }
